...
//        )
        ...
        //Attempt 2
//        var n=serviceList.size
//        var temp:Service
//        for(i in 0..n-1){
//            var indexOfMin = i
//            for(j in n-1 downTo  i){
//                if(serviceList[j].price < serviceList[indexOfMin].price)
//                    indexOfMin=j
//            }
//            if(i!=indexOfMin){
//                temp = serviceList[i]
//                serviceList[i]= serviceList[indexOfMin]
//                serviceList[indexOfMin]=temp
//            }
//        }

        //Attempt 3
        //val sortedServiceList : MutableList<Service> = serviceList.sortedBy { Service -> Service.price } as MutableList<Service>
